<div style="margin-left: 20px; font-size: 1.2em;">
	...
	<p class="MsoNormal">Diese Zusammenstellung ist das erste Manual zur Nutzung des
		Tools Livefeedback+ (Link: <a href="https://vikole.bio.uni-kl.de/"><span style="text-decoration:none">https://vikole.bio.uni-kl.de/</span></a>).
		<br/>
	...
	<ol>
		...
		<div>
			...
			<p><img width="604" height="40" id="Grafik 3" src="Scripts/MANUAL/Anleitung_LFP/image002.jpg "></p>
			<p>Um die Registrierung starten zu können, muss der vom Dozenten zur Verfügung gestellte
				Registrierungsschlüssel
				angegeben werden.</p>

			<p><img width="218" height="96" id="Grafik 20" src="Scripts/MANUAL/Anleitung_LFP/image003.jpg"></p>

			<p>Füllen Sie die Felder aus, bestätigen Sie die Datenschutzerklärung und klicken Sie auf
				„Registrieren“</p>

			<p><img width="199" height="226" src="Scripts/MANUAL/Anleitung_LFP/image004.png"></p>
			...
			<ol type="a">
				...
				<div>
					...
					<p><img width="605" height="75" id="Grafik 2"
					        src="Scripts/MANUAL/Anleitung_LFP/image007.jpg"></p>
				...
				<div>
					...
					<p><img width="621" height="297" id="Grafik 4"
					        src="Scripts/MANUAL/Anleitung_LFP/image009.jpg">
					</p>
				...
				<div>
					...
					<p><img width="335" height="287"
					        id="Grafik 6"
					        src="Scripts/MANUAL/Anleitung_LFP/image010.jpg">
					</p>
					...
					<p><img width="605" height="313"
					        id="Grafik 8"
					        src="Scripts/MANUAL/Anleitung_LFP/image011.jpg">
					</p>
				...
				<div>
					...
					<p><img width="605" height="279"
					        id="Grafik 9"
					        src="Scripts/MANUAL/Anleitung_LFP/image012.jpg">
					</p>
				...
				<div>
					...
					<p class="MsoNormal"><img
							...
							height="227"
							id="Grafik 11"
							src="Scripts/MANUAL/Anleitung_LFP/image013.jpg">
					</p>
