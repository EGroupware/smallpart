 ...
 */
export class et2_smallpart_overlay_html extends et2_html {
    /**
     * Constructor
     */
 ...
 * Editor widget
 */
export class et2_smallpart_overlay_html_editor extends et2_htmlarea {
    /**
     * Constructor
     */
    constructor(_parent, _attrs, _child) {
        ...
        if (this.options.offset)
            this.set_offset(this.options.offset);
    }
    set_offset(_value) {
        this.offset = _value;
        if (this.editor) {
