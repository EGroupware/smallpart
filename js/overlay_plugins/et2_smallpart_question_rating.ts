 ...
 */
export class et2_smallpart_question_rating extends et2_smallpart_overlay_html implements et2_IOverlayElement
{
 ...
 */
export class et2_smallpart_question_rating_editor extends et2_smallpart_overlay_html_editor implements et2_IOverlayElementEditor
{
	static readonly _attributes : any = {
	};
