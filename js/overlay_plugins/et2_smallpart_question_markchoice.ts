...
import {MarkArea,CommentMarked} from "../mark_helpers";
...
export class et2_smallpart_question_markchoice extends et2_smallpart_overlay_html implements et2_IOverlayElement
{
	...
	constructor(_parent, _attrs? : WidgetConfig, _child? : object)
	{
		...
		if (this.videobar)
		{
			...
			this.videobar.setMarks(MarkArea.colorDisjunctiveAreas(
				MarkArea.markDisjunctiveAreas(mark_values, this.videobar.video.width()/this.videobar.video.height()),
				this.videobar.get_marking_colors()));
